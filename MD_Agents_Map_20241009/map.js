...
var map = L.map('map').setView([25.7939, -80.18825], 10.6);
...
//BELOW IS OLD CODE THAT WOULD INCLUDE ALL CATEGORICAL INFORMATION EVEN IF THE VALUE WAS BLANK
//     // Add a popup to the circle marker with property information
//     circleMarker.bindPopup(
//         `<h3>Transaction Details</h3>
//         <b>Address:</b> ${address}<br>
//          <b>Price:</b> ${price}<br>
//          <b>Listing Agent/Team 1:</b> ${listAgentOne}<br>
//          <b>Listing Brokerage 1:</b> ${listBrokerageOne}<br>
//          <b>Listing Agent/Team 2:</b> ${listAgentTwo}<br>
//          <b>Listing Brokerage 2:</b> ${listBrokerageTwo}<br>
//          <b>Buying Agent/Team 1:</b> ${buyAgentOne}<br>
//          <b>Buying Brokerage 1:</b> ${buyBrokerageOne}<br>
//          <b>Buying Agent/Team 2:</b> ${buyAgentTwo}<br>
//          <b>Buying Brokerage 2:</b> ${buyBrokerageTwo}<br>
//          <b>MLS Number:</b> ${mls}<br>`


//BELOW CODE IS IF WE WANT TO USE PIN MARKERS INSTEAD OF VARIABLE SIZING CIRCLE MARKERS
//     // Use this block of code to create pin markers for each location instead of sizeable circles
//     var marker = L.marker([lat, lon]).addTo(map);

//     // Add a popup to the marker with property information
//     marker.bindPopup(
//         `<h3>Transaction Details</h3>
//         <b>Address:</b> ${address}<br>
//          <b>Price:</b> ${price}<br>
