...
# # Use the open_by_key method with your sheet ID
...
#     # Click [aria-label="Main content"] >> text=Savings >> nth=4
...
#     # Convert your final_df DataFrame to a list of lists.
#     data = df_final.values.tolist()

#     # Insert all rows at once starting at row 2.
